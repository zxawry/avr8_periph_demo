...
void ssd1306_set_page(uint8_t start, uint8_t end)
{
	...
	_ssd1306_send(SSD1306_SET_PAGE_ADDR, TWI_NOSTOP);
	_ssd1306_send(start, TWI_NOSTART | TWI_NOSTOP);
	_ssd1306_send(end, TWI_NOSTART);
}
...
void ssd1306_set_column(uint8_t start, uint8_t end)
{
	...
	_ssd1306_send(SSD1306_SET_COLUMN_ADDR, TWI_NOSTOP);
	_ssd1306_send(start, TWI_NOSTART | TWI_NOSTOP);
	_ssd1306_send(end, TWI_NOSTART);
}
